...
2. **Recording** \- Feedback details are captured in the system, including the specific service or product it relates to.
...
2. Username \= \<YourCompanyName\>.\<YourFirstName\>@hdb.sf.review  
   e.g. UniversalContainers.John@hdb.sf.review
